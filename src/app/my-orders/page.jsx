...
//         <div className="text-[#8B5E3C] dark:text-yellow-400 text-xl">🍞 Loading orders...</div>
//       </div>
//     )
//   }
...
//       {/* Header */}
//       <div className="bg-gradient-to-br from-[#2C1810] to-[#5C3317] py-12 px-6 text-center">
//         <span className="block text-[#C9A84C] text-xs font-bold tracking-[4px] uppercase mb-2">
//           My Account
//         </span>
//         <h1
...
//         >
//           My <em className="italic text-[#C9A84C]">Orders</em>
//         </h1>
//       </div>

//       {/* Tabs */}
//       <div className="bg-white dark:bg-[#2C1810] border-b border-yellow-700/20">
//         <div className="max-w-5xl mx-auto px-4 flex">
//           {[
//             ['regular', `📦 Regular Orders (${orders.length})`],
//             ['custom', `🎂 Custom Orders (${customOrders.length})`],
//           ].map(([key, label]) => (
//             <button
//               key={key}
//               onClick={() => setActiveTab(key)}
//               className={`px-5 py-4 text-xs sm:text-sm font-bold tracking-wide uppercase border-none cursor-pointer transition-all duration-300 border-b-2
//                 ${activeTab === key
//                   ? 'border-[#C9A84C] text-[#C9A84C] bg-transparent'
//                   : 'border-transparent text-[#8B5E3C] dark:text-yellow-200/50 bg-transparent hover:text-[#C9A84C]'
//                 }`}
//             >
//               {label}
//             </button>
...
//                         <div className="w-10 h-10 bg-[#FDF6EC] dark:bg-[#1A0F0A] flex items-center justify-center text-xl">
//                           📦
//                         </div>
//                         <div>
//                           <div className="font-mono text-xs text-[#8B5E3C] dark:text-yellow-400">
//                             #{order._id.slice(-6).toUpperCase()}
//                           </div>
//                           <div
//                             className="font-semibold text-sm sm:text-base text-[#2C1810] dark:text-[#F5E6C0]"
//                             style={{ fontFamily: 'Playfair Display, serif' }}
//                           >
...
//                       <div className="flex items-center gap-3">
//                         <span
//                           className="font-bold text-[#2C1810] dark:text-[#C9A84C]"
//                           style={{ fontFamily: 'Playfair Display, serif' }}
//                         >
...
//                         </span>
//                         <span className="text-[#8B5E3C] dark:text-yellow-400 text-sm">
//                           {isExp ? '▲' : '▼'}
//                         </span>
//                       </div>
//                     </div>
...
//                               <div key={i} className="flex justify-between items-center bg-white dark:bg-[#2C1810] px-4 py-2.5 border border-yellow-700/15">
//                                 <span className="text-sm text-[#2C1810] dark:text-[#F5E6C0]">
//                                   {item.name} × {item.quantity}
//                                 </span>
//                                 <span className="font-semibold text-sm text-[#2C1810] dark:text-[#C9A84C]">
...
//                                   Rs. {(order.totalAmount + deliveryFee).toLocaleString()}
//                                 </span>
//                               </div>
//                             </div>
//                           </div>
...
//                         <Link
//                           href="/menu"
//                           className="mt-4 inline-block bg-[#C9A84C] text-[#2C1810] px-6 py-2.5 text-xs font-bold tracking-widest uppercase no-underline hover:bg-yellow-400 transition-colors"
//                         >
//                           🔄 Order Again
//                         </Link>
//                       </div>
...
//               desc="Place a custom cake order for your special occasion!"
//               href="/custom-order"
//               btnText="Order Custom Cake"
//             />
//           ) : (
//             <div className="flex flex-col gap-4">
...
//                           </span>
//                         ) : (
//                           <span className="text-xs text-[#8B5E3C] dark:text-yellow-200/40 italic">
//                             Price pending...
//                           </span>
//                         )}
//                         <span className={`text-xs font-bold px-2.5 py-1 ${sc.bg} ${sc.text}`}>
...
//       <h2
//         className="text-2xl font-bold text-[#2C1810] dark:text-[#F5E6C0]"
//         style={{ fontFamily: 'Playfair Display, serif' }}
//       >
//         {title}
//       </h2>
...
//       <Link
//         href={href}
//         className="bg-[#C9A84C] text-[#2C1810] px-8 py-3 text-sm font-bold tracking-widest uppercase no-underline hover:bg-yellow-400 transition-colors"
//       >
//         {btnText}
//       </Link>
//     </div>
                  ...
                  <div key={order._id} className="bg-white dark:bg-[#2C1810] border border-yellow-700/20 overflow-hidden">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* Payment Status Badge — header mein */}
                        {isOnline && (
                      ...
                      <div className="border-t border-yellow-700/15 p-4 sm:p-5 bg-[#FDF6EC] dark:bg-[#1A0F0A]/50">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex flex-col gap-2">
                            {order.items?.map((item, i) => (
                              <div key={i} className="flex justify-between items-center bg-white dark:bg-[#2C1810] px-4 py-2.5 border border-yellow-700/15">
                                <span className="text-sm text-[#2C1810] dark:text-[#F5E6C0]">{item.name} × {item.quantity}</span>
                                <span className="font-semibold text-sm text-[#2C1810] dark:text-[#C9A84C]">Rs. {(item.price * item.quantity).toLocaleString()}</span>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="bg-white dark:bg-[#2C1810] border border-yellow-700/15 p-4">
                            <div className="text-xs font-bold tracking-widest uppercase text-[#C9A84C] mb-2">📍 Delivery Info</div>
                            <div className="text-sm text-[#2C1810] dark:text-[#F5E6C0]/80 space-y-1">
                              <p><span className="font-semibold">Name:</span> {order.customerName}</p>
                              <p><span className="font-semibold">Phone:</span> {order.customerPhone}</p>
                              <p><span className="font-semibold">Address:</span> {order.deliveryAddress}</p>
...
function EmptyState({ emoji, title, desc, href, btnText }) {
  return (
    <div className="text-center py-16 flex flex-col items-center gap-4">
      <div className="text-7xl">{emoji}</div>
      <h2 className="text-2xl font-bold text-[#2C1810] dark:text-[#F5E6C0]" style={{ fontFamily: 'Playfair Display, serif' }}>
        {title}
      </h2>
      <p className="text-[#8B5E3C] dark:text-yellow-200/60">{desc}</p>
